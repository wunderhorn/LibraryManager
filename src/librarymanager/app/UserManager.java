...
public interface UserManager {
	 ...
	 *             levee si l'utilisateur specifie en parametre est deja present
	 ...
	 * @throws UserNotExistException
	 *             levee si le login de l'utilisateur specifie en parametre ne
	 *             correspond a aucun utilisateur enregistre dans la base de
	 *             donnees
	 */
